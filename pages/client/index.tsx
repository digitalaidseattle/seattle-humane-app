                  ...
                  <div className="card mb-0">
                    ...
                    <ul className="list-none p-0 m-0">
                      <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                        ...
                        <InputText id="description" type="text" value={ticket.description} onBlur={() => update()} onChange={(e) => changeProp('summary', e.target.value)} />
                      </li>
                      <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                    ...
                    <ul className="list-none p-0 m-0">
                      <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                        ...
                        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">
                          <InputText id="name" type="text" onBlur={() => update()} onChange={(e) => changeProp('name', e.target.value)} />
                        </div>
                      </li>
                      <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                      ...
                      <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
                        ...
                        <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">
                          <InputText id="email" type="text" onBlur={() => update()} onChange={(e) => changeProp('email', e.target.value)} />
                        </div>
                      </li>
                    </ul>
                  </div>
